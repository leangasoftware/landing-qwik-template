...
const routes = [
  [/^\/$/, [Layout, () => Index], void 0, "/", ["q-fa579d56.js", "q-fda643dc.js"]],
  [/^\/([^/]+?)\/?$/, [Layout, () => Topic], ["topic"], "/[topic]", ["q-fa579d56.js", "q-2b884a19.js", "q-6912fc97.js"]]
];
const menus = [];
...
const Social = () => {
  return /* @__PURE__ */ jsx(Fragment, {
    children: [
      ...
      /* @__PURE__ */ jsx("meta", {
        name: "description",
        content: "\u{1F680} Comienza haciendo tus despliegues directamente a la Nube. \u{1F64C} Qu\xE9 esperas mejorar tus habilidades en la programaci\xF3n ahora mismo."
      }),
      /* @__PURE__ */ jsx("meta", {
        property: "og:type",
        content: "website"
